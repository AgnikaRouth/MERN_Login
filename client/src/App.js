...
function App() {
	...
	const logout = async () => {
		try {
			...
			const response = await apiJWT.post('/logout', {
				token: refreshedData.refreshToken,
			});
			console.log(response.data); // Log the logout success message
